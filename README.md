...
Currently working at **NuNet** as a **Senior Software Engineer** and **P2P/Network Engineer**. [@nunet.io](https://nunet.io) in the [DMS](https://gitlab.com/nunet/device-management-service) project to enable a decentralized network of compute resources.
...
### ⚙️ High-Throughput Backends & Infrastructure
...
- **Email**: `ouaghad.hamza@gmail.com`  
- **GitHub**: [`github.com/derrandz`](https://github.com/derrandz)  
- **GitLab**: [`gitlab.com/derrandz`](https://gitlab.com/derrandz)  
